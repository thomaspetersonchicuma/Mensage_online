...
<head>
  ...
  <title>SGRBC - CrendenciasFuncionario</title>
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-imag">
              	<img src="${pageContext.request.contextPath}/resources/assets/img/pip.jpg" alt="">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="http://localhost:8080/daw2019/usuario/create">Criar Conta</a>
                  </div>
                </div>
              </div>
            </div>
